...
module.exports = class extends Generator {
    ...
    async writing() {
        ...
        this.log(
            "Add the new usage in your view with the following code: \n '<core:ComponentContainer width='100%' usage='" +
                sUsageName +
                "' propagateModel='true' lifecycle='Container'></core:ComponentContainer>'"
        );
    }
};
